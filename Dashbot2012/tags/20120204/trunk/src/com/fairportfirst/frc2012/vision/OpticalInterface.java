        ...
        if(image != null)
        {
            try {
                ...
                for(int q = 0; q < reports.length; q++)
                {
                    ...
                    if(q == 1)
                    {
                        System.out.println("WAY: " + whichWayMove(r.center_mass_x));
                    }
                    System.out.println("X " +r.center_mass_x + " : Left  " + r.boundingRectLeft);
                    System.out.println("WIDTH: " + r.imageWidth);
                }
