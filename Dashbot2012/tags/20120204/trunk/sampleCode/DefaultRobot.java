...
public class DefaultRobot extends IterativeRobot {
    ...
    public DefaultRobot() {
        ...
        spikeOne = new Relay(4,1,Relay.Direction.kForward);
        victorBob = new Victor(4,10);
        telepathyControl  = new Joystick(1);
	...
	public void teleopInit() {
        ...
        //victorBob.set(0.8 * Math.sin(speedVar) + 0.4);
        //victorBob.set();
		ClearSolenoidLEDsKITT();
        //speedVar += Math.PI / 18000;
	}
...
//	}
	...
	public void autonomousPeriodic() {
	   ...
	   public void teleopPeriodic() {
         ...
         */
        System.out.println(/*"QQQ " + telepathyControl.getY() + " QQQ " + telepathyControl.getX()*/
                /*+ */"QQQ  " + telepathyControl.getMagnitude());
        victorBob.set(telepathyControl.getY());
